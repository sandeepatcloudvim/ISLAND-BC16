report 50005 "Stock Status by Location & Bin"
{
    // version NAVNA10.00,CBR_SS

    DefaultLayout = RDLC;
    RDLCLayout = './Stock Status by Location & Bin.rdlc';
    CaptionML = ENU = 'Stock Status by Location & Bin',
    ...
    dataset
    {
        dataitem(Item; Item)
        {
            ...
            RequestFilterFields = "No.", "Inventory Posting Group", "Vendor No.", "Location Filter", "Bin Filter";
            ...
            {
                DataItemLink = "Item No." = FIELD("No."), "Registering Date" = FIELD("Date Filter"), "Location Code" = FIELD("Location Filter"), "Bin Code" = FIELD("Bin Filter");
