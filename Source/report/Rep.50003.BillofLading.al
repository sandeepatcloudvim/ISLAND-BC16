report 50003 "Bill of Lading"
{
    ...
    RDLCLayout = './Bill of Lading.rdlc';
    WordLayout = './Bill of Lading.docx';
    ...
    dataset
    {
        dataitem("Sales Header"; "Sales Header")
        {
            ...
            column(ShipTo1; "Sales Header"."Sell-to Customer No.")
            {
            }
            column(SelltoCustomerNo_SalesHeader; "Sales Header"."Sell-to Customer No.")
            {
            }
            column(ShipName_SH; "Sales Header"."Ship-to Name")
            {
            }
            column(ShipName2_SH; "Sales Header"."Ship-to Name 2")
            {
            }
            column(ShipAddress_SH; "Sales Header"."Ship-to Address")
            {
            }
            column(ShipAddress2_SH; "Sales Header"."Ship-to Address 2")
            {
            }
            column(ShipCity_SH; "Sales Header"."Ship-to City")
            {
            }
            column(ShipPostCode_SH; "Sales Header"."Ship-to Post Code")
            {
            }
            column(ShipConty_SH; "Sales Header"."Ship-to County")
            {
            }
            column(ShipCountyCode_SH; CountryName)
            {
            }
            dataitem(CopyLoop; "Integer")
            {
                ...
                dataitem(PageLoop; "Integer")
                {
                    ...
                    column(InvoiceNo; "Sales Header".Invoice)
                    {
                    }
                    ...
                    dataitem(RoundLoop; "Integer")
                    {
                        ...
                        column(CasePack; "Sales Line"."Quantity (Base)")
                        {
                        }
